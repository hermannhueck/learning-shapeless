...
// ----- 3.2.2 Instances for concrete products", leading = "\n"
...
// using implicit encoder
writeCsv(employeesWithIceCreams)

// ----- 3.2.3 So what are the downsides? Two typical errors ...", leading = "\n"

// --- 1. The object to encode is not an ADT, e.g. a normal class.
...
// --- 2. One of the case class params has no CsvEncoder instance.
