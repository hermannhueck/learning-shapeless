...
object FibonacciExamples {
  ...
  object Fibonacci {
    ...
    implicit val fib0: Fibonacci[_0, _0] =
      Fibonacci(0, 0)
    implicit val fib1: Fibonacci[_1, _1] =
      Fibonacci(1, 1)
  ...
  def fibs[L <: HList](n: Nat)(implicit fibs: Fibs[n.N, L], reverse: Reverse[L]) = fibs().reverse
