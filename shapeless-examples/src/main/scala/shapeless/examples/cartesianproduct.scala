...
object CartesianProductExample extends App {
  ...
  object ApplyMapper {
    implicit def hnil[HF, A]: ApplyMapper[HF, A, HNil, HNil] =
    ...
    ): ApplyMapper[HF, A, XH :: XT, OutH :: OutT] =
  ...
  object LiftA2 {
    implicit def hnil[HF, Y <: HList]: LiftA2[HF, HNil, Y, HNil] =
