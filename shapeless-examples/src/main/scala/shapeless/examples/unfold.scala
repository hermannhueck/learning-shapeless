...
object UnfoldExamples extends App {
  ...
  object Unfold {
    ...
    trait ApplyUnfold[E] {
      def apply[S, L <: HList](f: Poly)(s: S)(implicit unfold: UnfoldAux[f.type, E, S, E, L]) = unfold(s)
    }
  ...
  object unfoldMisc extends Poly1 {
    implicit def case0: Case.Aux[_0, (Int, _1)] =
      at[_0](_ => (23, _1))
    implicit def case1: Case.Aux[_1, (String, _2)] =
      at[_1](_ => ("foo", _2))
    implicit def case2: Case.Aux[_2, (Boolean, _3)] =
      at[_2](_ => (true, _3))
    implicit def case3: Case.Aux[_3, (Double, _4)] =
      at[_3](_ => (1.0, _4))
  }
  ...
  object unfoldFibs extends Poly1 {
    implicit def case0: Case.Aux[_0, (_0, _1)] =
      at[_0](_ => (_0, _1))
    implicit def case1: Case.Aux[_1, (_1, _2)] =
      at[_1](_ => (_1, _2))
    ...
    ): Case.Aux[Succ[Succ[N]], (FSSN, Succ[Succ[Succ[N]]])] =
      at[Succ[Succ[N]]](_ => ((fssn.value: FSSN), Succ[Succ[Succ[N]]]()))
  }

  object toInt extends Poly1 {
    implicit def default[N <: Nat](implicit toInt: ToInt[N]): Case.Aux[N, Int] =
      at[N](_ => toInt())
  }
