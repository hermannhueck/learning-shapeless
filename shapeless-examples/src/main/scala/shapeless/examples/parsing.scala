...
object CombinatorTesting extends App {
  ...
  /**
    ...
    */
  implicit def flattenString: Flatten[String] =
    new Flatten[String] {
  ...
  /**
    ...
    */
  implicit def flattenPattern[A, B](implicit flattenA: Flatten[A], flattenB: Flatten[B]): Flatten[A ~ B] =
    new Flatten[A ~ B] {
  ...
  /**
    ...
    */
  implicit def flattenParseResult[T](implicit flattenP: Flatten[T]): Flatten[ParseResult[T]] =
