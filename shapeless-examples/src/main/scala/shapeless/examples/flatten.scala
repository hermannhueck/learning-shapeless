...
object FlattenExample {
  ...
  trait LowPriorityFlatten extends Poly1 {
    implicit def default[T]: Case.Aux[T, Tuple1[T]] =
      at[T](Tuple1(_))
  }
  object flatten extends LowPriorityFlatten {
    implicit def caseTuple[P <: Product](implicit lfm: Lazy[FlatMapper[P, flatten.type]]): Case.Aux[P, lfm.value.Out] =
      at[P](lfm.value(_))
  }
  ...
  object toDouble extends Poly1 {
    implicit def caseInt: Case.Aux[Int, Double] =
      at[Int](_.toDouble)
    implicit def caseDouble: Case.Aux[Double, Double] =
      at[Double](identity)
  }
