...
object Sorting {
  ...
  implicit def hnilNonDecreasing: NonDecreasing[HNil] =
    new NonDecreasing[HNil] {}
  implicit def hlistNonDecreasing1[H]: NonDecreasing[H :: HNil] =
    new NonDecreasing[H :: HNil] {}
  implicit def hlistNonDecreasing2[H1 <: Nat, H2 <: Nat, T <: HList](
      implicit ltEq: H1 <= H2,
      ndt: NonDecreasing[H2 :: T]
  ): NonDecreasing[H1 :: H2 :: T] =
  ...
  trait LowPrioritySelectLeast {
    implicit def hlistSelectLeast1[H <: Nat, T <: HList]: SelectLeast[H :: T, H, T] =
  ...
  trait LowPrioritySelectionSort {
    implicit def hlistSelectionSort1[S <: HList]: SelectionSort[S, S] =
