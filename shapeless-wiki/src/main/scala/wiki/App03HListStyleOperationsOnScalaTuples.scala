...
object App03HListStyleOperationsOnScalaTuples extends App {
  ...
  // ----------------------------------------
  prtTitle("HList-style operations on standard Scala tuples")
  ...
  // ----------------------------------------
  prtSubTitle("head, tail, take, drop, split")
  ...
  // ----------------------------------------
  prtSubTitle("prepend, append, concatenate")
  ...
  // ----------------------------------------
  prtSubTitle("conversion to `HList`s and ordinary Scala `List`s")
